...
public class Frame extends JFrame implements ActionListener {
    ...
    public Frame() {	
		...
		String[] s = {"Styczeñ", "Luty", "Marzec", "Kwiecieñ", "Maj", "Czerwiec", "Lipiec", "Sierpieñ", "Wrzesieñ", "PaŸdziernik", "Listopad", "Grudzieñ"};
		...
		JButton buttonD = new JButton("Wyœwietl");
		...
		String[] ss = {"Temperatura", "Wilgotnoœæ", "Si³a wiatru", "Ciœnienie"};
		...
		JButton buttonE = new JButton("Wyœwietl ");
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	} else if (e.getActionCommand() == "Wyœwietl") { 
